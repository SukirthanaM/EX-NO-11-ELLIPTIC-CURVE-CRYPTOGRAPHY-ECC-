...
Point scalarMultiplication(Point P, long long int k, long long int a, long long 
int p)  
{  
    Point result = P;  
    k--;  
...
{  
    ...
    scanf("%lld", &p);  
    printf("Enter the curve parameters (a and b) for equation y^2 = x^3 + ax + 
b: ");  
    scanf("%lld %lld", &a, &b);  
...
<img width="644" height="328" alt="image" src="https://github.com/user-attachments/assets/f3b4008f-2a74-4965-b8a7-30b3002f4f16" />
